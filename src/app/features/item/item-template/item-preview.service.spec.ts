...
describe('ItemPreviewService', () => {
  beforeEach(() => TestBed.configureTestingModule({
    ...
    const cases = [
      ...
      { name: 'Sell Price',       template: { SellPrice: 123456 }, output: `<br>出售价格: <span class="moneygold">12</span> &nbsp;<span class="moneysilver">34</span> &nbsp;<span class="moneycopper">56</span> &nbsp;` },
      { name: 'Sell Price-1',     template: { SellPrice: 9999 }, output: `<br>出售价格: <span class="moneysilver">99</span> &nbsp;<span class="moneycopper">99</span> &nbsp;` },
      { name: 'Sell Price-2',     template: { SellPrice: 99 }, output: `<br>出售价格: <span class="moneycopper">99</span> &nbsp;` },
      ...
      { name: 'Bonding, unique', template: { bonding: 1, maxcount: 1 }, output: `<br><!-- [bonding] -->Binds when picked up<br><!-- unique[0] -->Unique` },
      { name: 'Maxcount cases', template: { maxcount: 2, BagFamily: 1 }, output: `<br><!-- unique[1] -->Unique (2)` },
      { name: 'Item Limit Category, is Gem', template: { ItemLimitCategory: 123 }, output: `<br><!-- unique isGem -->Unique-Equipped: Helias (2)` },
      { name: 'Item Limit Category, not Gem', template: { ItemLimitCategory: 1 }, output: `<br><!-- unique isGem -->Unique: Helias (2)` },
      ...
      { name: 'inventoryType, block', template: { class: ITEM_TYPE.AMMUNITION, block: 1 }, output: `<br><span>1 Block</span>` },
      { name: 'inventoryType, subclass', template: { class: ITEM_TYPE.AMMUNITION, subclass: 2 }, output: `<table style="float: left; width: 100%;"><tr><th>Arrow</th></tr></table>` },
      ...
      { name: 'Holy & Arcane resistances', template: { holy_res: 1, arcane_res: 1 }, output: `<br>+1 Holy Resistance<br>+1 Arcane Resistance` },
      { name: 'Gem Enchantment - success', template: { entry: 100, }, output: `<br><span class="q1">Helias</span><br><span class="q0">Requires less than 2 meta gems;</span><br><span class="q0">Requires more yellow gems than yellow gems</span>` },
      ...
      { name: 'Extended Cost - 2', template: { entry: 600, FlagsExtra: 0x04 }, output: `<br>Requires personal and team arena rating of 2200 in 3v3 or 5v5 brackets`},
      { name: 'Extended Cost - 3', template: { entry: 600 }, output: `<br>Requires personal and team arena rating of 2200 in 3v3 or 5v5 brackets`},
